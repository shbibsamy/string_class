...
Ici, lors de l’implémentation d’une méthode déclarée comme abstraite, on ne doit pas réécrire `abstract` puisque justement on implémente la méthode abstraite.  
